...
var backToMainBtns = document.querySelectorAll('.back-to-main');
...
var unmotivationalBtn = document.querySelector('.show-unmotivational');
var unmotivationalPage = document.querySelector('.unmotivational-posters');
...
showSavedBtn.addEventListener("click", () => displayPoster(savedPosters, posterGrid));
...
function showUnmotivationalPage() {
  mainPosterPage.classList.add("hidden");
